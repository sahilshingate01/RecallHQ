...
import { X, RefreshCw, Check, Link, AlertTriangle } from "lucide-react";
...
export default function AddTaskModal({ isOpen, onClose }: AddTaskModalProps) {
  ...
  const handleSubmit = () => {
    ...
    const taskData: Omit<Task, "id" | "completed" | "created_at"> = {
      title: title.trim(),
      description: description.trim(),
      type,
      priority,
      link: hasLink && link.trim() ? link.trim() : undefined,
    };
    addTask(taskData);
    handleClose();
  };
        ...
        >
          <motion.div
            ...
            style={{
              ...
              background: "#e8ecf4",
              boxShadow:
                "12px 12px 30px rgba(0,0,0,0.2), -10px -10px 30px rgba(255,255,255,0.9)",
              padding: "40px 36px",
            }}
          >
            {/* Header */}
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
                      ...
                      <motion.button
                        ...
                        style={{
                          ...
                          boxShadow: isSelected
                            ...
                            : "5px 5px 12px rgba(163,177,198,0.5), -5px -5px 12px rgba(255,255,255,0.8)",
                  ...
                  {priorities.map((p) => (
                    <motion.button
                      ...
                      style={{
                        ...
                        gap: 8,
                        background:
                          priority === p.id ? `${p.color}15` : "#e8ecf4",
                        color: priority === p.id ? p.color : "#9aa5b4",
                        boxShadow:
                          priority === p.id
                            ? "inset 2px 2px 5px rgba(0,0,0,0.1)"
                            : "4px 4px 10px rgba(163,177,198,0.5), -4px -4px 10px rgba(255,255,255,0.8)",
                        transition: "all 0.2s ease",
                      }}
                    >
                      <span
                        style={{
                          ...
                          background: p.color,
                          flexShrink: 0,
                          boxShadow: priority === p.id ? `0 0 8px ${p.color}60` : "none",
                        }}
                      />
                      {p.label}
                    </motion.button>
                ...
                {error && (
                  <motion.div
                    ...
                    style={{
                      ...
                      padding: "12px 16px",
                      borderRadius: 16,
                      background: "rgba(241,90,43,0.06)",
              ...
              <motion.button
                ...
                style={{
                  ...
                  fontSize: 17,
                  boxShadow:
                    "6px 6px 16px rgba(241,90,43,0.4), -4px -4px 12px rgba(255,255,255,0.8)",
                  marginTop: 8,
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
